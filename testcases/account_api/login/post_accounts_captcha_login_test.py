...
# FROM: .\testcases\account_api\login\post_accounts_captcha_login.yml
import pytest
...
class TestCasePostAccountsCaptchaLogin(HttpRunner):
    ...
    config = (
        Config("/accounts/captcha/login 发送登入验证码")
        .variables(
            **{
...
if __name__ == "__main__":
    TestCasePostAccountsCaptchaLogin().test_start()
